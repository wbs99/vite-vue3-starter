...
readonly SERVER_IP="10.56.57.228"         # 服务器IP地址
readonly SSH_PORT="2202"                   # SSH端口号
readonly DEPLOY_DIR="/usr/local/software/front_end_admin"  # 部署目录
readonly FRONTEND_DIR="zhengwu-admin"        # 前端打包目录名称
...
# 代码检查
title '执行代码检查'
pnpm lint || { echo "代码检查失败！请修复代码中的问题后再尝试部署。"; exit 1; }
